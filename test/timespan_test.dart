...
void main() {
  group('Timespan', () {
    ...
    test('Timespan.fromOClock', () {
      final workday = Timespan.fromOClock(from: 9, to: 17, reference: DateTime(2023, 1, 1));
    ...
    test('cut method', () {
      ...
      expect(() => ts.cut(DateTime(2023, 1, 1, 9)), throwsA(isA<ArgumentError>()));
    });
  ...
  group('Timespanning mixin', () {
    ...
    test('Timespan iterable extensions', () {
      ...
      final other = [
        ...
        Timespan(begin: DateTime(2023, 1, 1, 17), end: DateTime(2023, 1, 1, 18)),
      ];
      ...
      expect(intersecting.length, 3);  // Each span intersects with the 9-13 timespan
      expect(intersecting.every((span) => span.begin == DateTime(2023, 1, 1, 9)), true);
    });
    ...
    test('Timespanning list extensions', () {
      ...
      final other = [
        TimespanningData(
          timespan: Timespan(begin: DateTime(2023, 1, 1, 11), end: DateTime(2023, 1, 1, 13)),
          value: 'other'
        ),
        TimespanningData(
          timespan: Timespan(begin: DateTime(2023, 1, 1, 17), end: DateTime(2023, 1, 1, 18)),
      ...
      expect(intersecting.every((item) => (item as TimespanningData).value == 'other'), true);
    });
  });
}